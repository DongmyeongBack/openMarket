...
export default class Header {
    ...
    template() {
        ...
        const logoHtml = `
            <h1 class="logo">
                <a href="/">
                    <img src="/src/assets/Logo-hodu.png" alt="HODU" class="logo-img">
                </a>
            </h1>
        `;
        ...
        if (!this.token) {
            ...
            navItemsHtml = `
                <button id="cart-btn" class="nav-btn">
                    <img src="/src/assets/icon-shopping-cart.svg" alt="장바구니">
                    <span>장바구니</span>
                </button>
                <a href="/src/pages/login/index.html" class="nav-btn">
                    <img src="/src/assets/icon-user.svg" alt="로그인">
                    <span>로그인</span>
                </a>
            `;
            ...
            navItemsHtml = `
                ...
                <a href="/src/pages/seller-center/index.html" class="btn-seller-center">
                    <img src="/src/assets/icon-shopping-bag.svg" alt="쇼핑백">
                    판매자 센터
                </a>
