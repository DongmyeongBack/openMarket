...
<table>
  <tr>
    <th width="50%" align="center">구매자 회원가입</th>
    <th width="50%" align="center">판매자 회원가입</th>
  </tr>
  <tr>
    <td align="center">
...
<table>
  <tr>
    <th width="50%" align="center">구매자 (Buyer)</th>
    <th width="50%" align="center">판매자 (Seller)</th>
  </tr>
  <tr>
    <td align="center">
...
<table>
  <tr>
    <th width="50%" align="center">구매자 시점</th>
    <th width="50%" align="center">판매자 시점</th>
  </tr>
  <tr>
    <td align="center">
...
<table>
  <tr>
    <th width="50%" align="center">판매자 대시보드</th>
    <th width="50%" align="center">상품 등록/수정</th>
  </tr>
  <tr>
    <td align="center">
...
#### 6-1-1. 탭(Tab) 기반 UI: 구매자와 판매자 회원을 탭으로 구분하여, 로그인 타입을 명확히 선택하고 전환할 수 있습니다. 판매자 탭 선택 시 사업자 전용 필드(등록번호, 스토어명)가 동적으로 노출됩니다.

#### 6-1-2. 로그인 유효성 검사 및 UX:
...
### 6-2. 헤더 및 네비게이션 (Global Navigation Bar)
...
#### 6-2-2. 검색 기능 (Search Implementation)
...
### 6-3. 메인 및 상품 목록 (Home & Product List)
...
- **바로 구매**: 로그인 체크 후, 주문 정보를 저장하고 결제 페이지로 즉시 이동합니다.

</details>

### 6-5. 장바구니 및 결제 (Cart & Payment)
...
#### 6-6-2. 상품 관리 (Product Management)
...
> 팀장으로서 프로젝트 전반의 기술적 의사결정과 협업 프로세스를 조율하며 성장했습니다. Vite 환경 설정과 배포 경로 이슈를 해결하며 빌드 도구에 대한 이해를 높였고, API 모듈화로 로직의 재사용성을 확보했습니다. 특히 로그인 구현 과정에서 고민했던 보안 이슈(XSS)는 앞으로 더 안전한 웹 서비스를 설계하기 위한 확실한 학습 목표가 되었습니다. 또한 초기에는 PR 워크플로우 도입을 시도했으나, 팀의 상황과 개발 속도를 고려하여 유연하게 프로세스를 조정했습니다. 대신 명확한 WBS 관리를 통해 프로젝트 진행 상황을 투명하게 공유하며 협업의 빈틈을 메웠습니다.
...
> GitHub을 통한 협업 과정에서 강의 초반에 배운 git add → git commit → git push → git pull 흐름을 실제 프로젝트에 적용하며 충분히 실습할 수 있었고, HTML과 CSS에 비해 이해가 쉽지 않았던 JavaScript 개념들도 기능 구현과 함께 활용해 보며 점차 구조적으로 이해하게 되었습니다. 작은 규모의 프로젝트였지만 처음 배운 여러 과정들이 차곡차곡 쌓여 하나의 결과물로 완성되어 가는 흐름을 경험할 수 있었으며, 팀장의 도움을 통해 AI 도구를 보다 적극적으로 활용하는 방법을 익히고 동료 팀원의 실무 경험에서 얻은 조언을 통해 UI를 바라보는 새로운 시각을 배울 수 있었습니다. 또한 “오늘은 이런 부분을 도와주세요”라는 요청에 책임감을 가지고 임하며 여러 방법을 시도하고 해결해 나가는 과정 속에서 지속적인 학습과 성장을 경험할 수 있는 의미 있는 시간이었습니다.
