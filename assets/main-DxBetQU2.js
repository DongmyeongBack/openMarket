import{g as d}from"./api-CJgaIYVr.js";import{H as m}from"./Header-pqP7kw2J.js";import{F as u}from"./Footer-DnPTH6_A.js";import"./Modal-paOObtiz.js";let r=0;const l=5;let a,c;async function f(){try{const e=await d();g(e.results),p(e.results)}catch(e){console.error("Error loading products:",e),a&&(a.innerHTML=`
