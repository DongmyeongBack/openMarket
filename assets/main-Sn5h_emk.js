import{g as d}from"./api-CJgaIYVr.js";import{H as m}from"./Header-J1DagpnZ.js";import{F as u}from"./Footer-DnPTH6_A.js";import"./Modal-CoTgg4te.js";let r=0;const l=5;let a,c;async function f(){try{const e=await d();g(e.results),p(e.results)}catch(e){console.error("Error loading products:",e),a&&(a.innerHTML=`
                ...
                </p>`)}}function g(e){if(!a)return;if(!e||e.length===0){a.innerHTML='<p style="text-align:center; grid-column: 1/-1;">등록된 상품이 없습니다.</p>';return}const s=e.map(t=>{const n=new Intl.NumberFormat("ko-KR").format(t.price),o=t.seller.store_name||t.seller.username;return`
            <li class="product-card">
                <a href="/openMarket//pages/product-detail/index.html?productId=${t.id}">
