import{g as d}from"./api-BjdzUVpJ.js";import{H as m}from"./Header-DfL1z1yh.js";import{F as u}from"./Footer-DnPTH6_A.js";import"./Modal-paOObtiz.js";let r=0;const l=5;let a,c;async function f(){try{const e=await d();g(e.results),p(e.results)}catch(e){console.error("Error loading products:",e),a&&(a.innerHTML=`
